...
const AIAcademy = () => {
  ...
  return (
    <div className="academy bg-[#0C140F] text-white">
      <SEO
        title="Simplí AI Academy — treinamento, configuração e mentoria de IA para empresas"
        description="O braço educacional da Simplí. Treinamento Claude em grupo (R$ 297), consultoria de configuração de ambiente (R$ 500), treinamento in-company e mentoria com diagnóstico de processo (R$ 2.997)."
        ...
        ogTitle="Simplí AI Academy — IA que entra no processo da sua empresa"
        ogDescription="Quatro formatos, do treinamento em turma à mentoria com diagnóstico de processo. Do «ouvi falar de IA» ao «tenho IA rodando dentro do meu processo»."
        structuredData={[
          organizationSchema,
          breadcrumbSchema,
          faqSchema,
      ...
      <section className="relative overflow-hidden px-6 pb-20 pt-16 md:px-10 md:pb-28 md:pt-24">
        ...
        <div className="relative mx-auto flex max-w-6xl flex-col items-center text-center">
          ...
          <div className="academy-rise academy-rise-1 aspect-[4/1] w-full max-w-[380px] md:max-w-[460px]">
            <img
              src="/ai-academy-logo-branca.png"
              alt="Simplí AI Academy"
          ...
          <p className="academy-rise academy-rise-3 mt-7 max-w-[62ch] text-lg leading-relaxed text-white/75 md:text-xl">
            O braço educacional da Simplí. Quatro formatos, do treinamento em
            turma à mentoria com diagnóstico completo — todos configurando IA
      ...
      >
        <div className="mx-auto max-w-6xl">
          <h2 className="max-w-[20ch] text-3xl font-bold leading-tight text-white md:text-[2.75rem]">
            Os quatro formatos, em ordem de profundidade
          </h2>
          <p className="mt-4 max-w-[62ch] text-lg leading-relaxed text-white/70">
            Cada um resolve um estágio diferente. Nenhum depende do outro — mas
            eles se conectam.
          </p>
      ...
      <section className="px-6 pb-24 pt-8 md:px-10 md:pb-32">
        ...
        >
          ...
          <div className="relative">
            <h2 className="max-w-[22ch] text-balance text-3xl font-bold leading-tight text-white md:text-[2.75rem]">
              Comece pela turma. São dez vagas.
            </h2>
            <p className="mt-5 max-w-[58ch] text-lg leading-relaxed text-white/75">
              ...
              durante a aula. R$ 297 na primeira turma — R$ 497 nas seguintes.
            </p>
