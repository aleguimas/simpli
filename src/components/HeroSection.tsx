...
const HeroSection = () => {
  ...
  const buttonBaseClasses =
    "min-h-[48px] h-12 w-full sm:w-auto sm:min-w-[190px] rounded-xl px-6 text-base font-semibold sm:px-7 sm:text-lg touch-manipulation";
      ...
      <div className="mx-auto flex min-h-[80vh] max-w-6xl flex-col items-center justify-center text-center">
        ...
        >
          <img
            ...
            loading="lazy"
          />
          <h1 className="mt-6 pb-3 bg-gradient-to-r from-white via-white/90 to-white/40 bg-clip-text text-4xl font-semibold leading-tight text-transparent sm:text-5xl md:text-6xl lg:text-7xl">
