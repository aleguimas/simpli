...
const pillars: Pillar[] = [
  {
    letter: "S",
    title: "S – Segurança: operação monitorada 24/7.",
    description:
  ...
  {
    letter: "I",
    title: "I – Inovação: antecipamos problemas e oportunidades.",
    description:
