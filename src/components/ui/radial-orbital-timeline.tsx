  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute h-16 w-16 rounded-full bg-gradient-to-br from-[#4ADE80] via-[#22d3ee] to-[#7c3aed] animate-pulse flex items-center justify-center z-10 shadow-[0_0_40px_rgba(74,222,128,0.45)]">
