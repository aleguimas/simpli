...
const RadialOrbitalTimeline = ({ timelineData }: RadialOrbitalTimelineProps) => {
  ...
  return (
    <div className="flex w-full max-w-[min(100vw,70rem)] flex-col items-center gap-8 px-4 sm:px-6">
      <div
        className="relative flex h-[520px] w-full max-w-4xl items-center justify-center overflow-hidden rounded-3xl"
        style={{ perspective: "1000px" }}
      >
        {/* Halo contido e concentrado no centro, com gradiente proporcional à largura disponível */}
        <div
          className="pointer-events-none absolute inset-0"
          aria-hidden
          style={{
            background:
              "radial-gradient(circle at center, rgba(255,255,255,0.9) 0%, rgba(255,255,255,0.28) 45%, rgba(255,255,255,0.08) 60%, rgba(255,255,255,0) 75%)",
          }}
        />
